...
import UpdateWarehouseLoader from "./UpdateWarehouseLoader";
import UpdateWarehouseForm from "./UpdateWarehouseForm";
import { getWarehouseById } from "@/actions/WarehouseAction";
...
const UpdateWarehouseModal = ({
  ...
  const fetchWarehouse = useEffectEvent(async () => {
    setLoading(true);
    try {
  ...
  if (loading) content = <UpdateWarehouseLoader />;
    ...
    content = (
      <UpdateWarehouseForm data={data as Warehouse} onSuccess={onSuccess} />
    );
            ...
            <DialogHeader>
              ...
              <DialogDescription>
                {loading ? (
                  ...
                  "Edit and manage the warehouse details from here."
                )}
              </DialogDescription>
            </DialogHeader>
            {content}
