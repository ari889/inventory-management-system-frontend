...
import ShowSummaryReport from "./_components/ShowSummaryReport";
export const dynamic = "force-dynamic";

export const generateMetadata = async () => {
  const { data } = handleResponse<Setting[]>(await getSettings());
  return {
    title: `Summary Report | ${data.find((s) => s.name === "title")?.value || "Inventory Management System"}`,
          ...
          <div className="flex flex-row justify-between items-center my-3">
            <div className="flex flex-row justify-start items-center">
              ...
              <div>
                ...
                <h3 className="text-gray-500">Manage Summary Report</h3>
              </div>
            </div>
          </div>
          <ShowSummaryReport />
