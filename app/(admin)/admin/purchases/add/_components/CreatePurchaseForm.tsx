...
import SelectProductAutocomplete from "./SelectProductAutocomplete";
...
const CreatePurchase = () => {
  ...
  //   code: product.code,
  //   taxId: product.taxId,
  //   taxRate: product.tax ? (product.tax.rate.toString() ?? "0.00") : "0.00",
  //   taxName: product.tax?.name?.toString() ?? "",
  //   unitId: product.unitId,
  //   unitName: product.unit?.unitName,
  //   unitCost: product.price,
  //   quantity: 1,
  //   discount: "0.00",
  //   subtotal: (Number(product.price) * Number(1)).toString(),
  // });

  const selectedProductData = products?.find(
    (p: PurchaseProductType) => p.id === selectedProduct,
  );
