...
type CategoryOption = Pick<ProductCategory, "id" | "name">;
...
function reducer(state: State, action: Action): State {
  switch (action.type) {
    ...
    case "FETCH_SUCCESS": {
      ...
      return {
        ...state,
        productCtegories: replace
          ? items
          : [...state.productCtegories, ...items],
...
export default function ProductCategoryFilter({
  ...
  const selectedLabel =
    ...
    state.productCtegories.find((r) => r.id === value)?.name;
              ...
              <CommandList ref={listRef} onScroll={handleScroll}>
                {state.searching ? (
                  ...
                  <>
                    ...
                    {state.productCtegories.map((category) => (
                      <CommandItem
                        key={category.id}
                        ...
                        onSelect={(val) => {
                          ...
                          const picked =
                            state.productCtegories.find((u) => u.id === num) ??
                            null;
