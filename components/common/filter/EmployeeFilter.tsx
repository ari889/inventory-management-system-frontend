...
export default function EmployeeFilter({
  ...
  const [selectedEmployee, setSelectedEmployee] =
    useState<EmployeeOption | null>(defaultEmployee);
  ...
  const selectedLabel =
    selectedEmployee?.name ?? state.employees.find((r) => r.id === value)?.name;
                    ...
                    {state.employees.map((employee) => (
                      <CommandItem
                        ...
                        onSelect={(val) => {
                          ...
                          const picked =
                            state.employees.find((u) => u.id === num) ?? null;
                          const isDeselecting = num === value;
                          setSelectedEmployee(isDeselecting ? null : picked);
