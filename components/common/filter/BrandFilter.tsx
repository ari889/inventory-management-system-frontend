...
type BrandOption = Pick<Brand, "id" | "title">;

type Props = {
  value: number | null;
  onChange: (value: number | null) => void;
  label?: string;
  defaultBrand?: BrandOption | null;
};
...
export default function BrandFilter({
  ...
  const selectedLabel =
    selectedBrand?.title ?? state.brands.find((r) => r.id === value)?.title;
                    ...
                    {state.brands.map((brand) => (
                      <CommandItem
                        ...
                        onSelect={(val) => {
                          ...
                          const picked =
                            state.brands.find((u) => u.id === num) ?? null;
                          const isDeselecting = num === value;
                          setSelectedBrand(isDeselecting ? null : picked);
