...
type UnitOption = Pick<Unit, "id" | "unitName">;

type Props = {
  value: number | null;
  onChange: (value: number | null) => void;
  label?: string;
  defaultUnit?: UnitOption | null;
};
...
export default function UnitFilter({
  ...
  const selectedLabel =
    selectedUnit?.unitName ?? state.units.find((r) => r.id === value)?.unitName;
                    ...
                    {state.units.map((unit) => (
                      <CommandItem
                        ...
                        onSelect={(val) => {
                          ...
                          setSelectedUnit(isDeselecting ? null : picked);
