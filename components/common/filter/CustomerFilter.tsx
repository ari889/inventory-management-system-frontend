...
export default function CustomerFilter({
  ...
  const [selectedCustomer, setSelectedCustomer] =
    useState<CustomerOption | null>(defaultCustomer);
  ...
  const selectedLabel =
    selectedCustomer?.name ?? state.customers.find((r) => r.id === value)?.name;
                    ...
                    {state.customers.map((customer) => (
                      <CommandItem
                        ...
                        onSelect={(val) => {
                          ...
                          const picked =
                            state.customers.find((u) => u.id === num) ?? null;
                          const isDeselecting = num === value;
                          setSelectedCustomer(isDeselecting ? null : picked);
